...
// -------
//
function ciniki_wng_generators_content(&$ciniki, $tnid, $request, $block) {
...
*/
    ...
    if( isset($block['content']) && $block['content'] != '' ) {
        ...
        $rc = ciniki_web_processContent($ciniki, $request['site']['settings'], $block['content'], ((isset($block['wide'])&&$block['wide']=='yes')?'wide':''));
        if( $rc['stat'] != 'ok' ) {
            return $rc;
        }
        if( $rc['content'] != '' ) {
