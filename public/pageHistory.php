...
// -------
//
function ciniki_wng_pageHistory($ciniki) {
    //
    ...
    $rc = ciniki_wng_checkAccess($ciniki, $args['tnid'], 'ciniki.wng.pageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.wng', 'ciniki_wng_history', $args['tnid'], 'ciniki_wng_pages', $args['page_id'], $args['field']);
}
?>
