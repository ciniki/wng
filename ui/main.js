...
function ciniki_wng_main() {
    ...
    this.site.page_id = '';
    this.site.sections = {
        '_tabs':{'label':'', 'type':'paneltabs', 'selected':'header', 'aside':'yes',
            'tabs':{
                'header':{'label':'Header', 'fn':'M.ciniki_wng_main.site.save("M.ciniki_wng_main.site.switchTab(\'header\');");'},
                'footer':{'label':'Footer', 'fn':'M.ciniki_wng_main.site.save("M.ciniki_wng_main.site.switchTab(\'footer\');");'},
                'other':{'label':'Other', 'fn':'M.ciniki_wng_main.site.save("M.ciniki_wng_main.site.switchTab(\'other\');");'},
//                'footer':{'label':'Footer', 'fn':'M.ciniki_wng_main.site.switchTab("footer");'},
        ...
        'headerpages':{'label':'Header Menu', 'type':'simplegrid', 'num_cols':1, 'aside':'yes',
            'visible':function() { 
                    if( M.ciniki_wng_main.site.view_aside == 'yes' 
                        && M.ciniki_wng_main.site.sections._tabs.selected == 'header' 
                        ) {
                        return 'yes';
                    }
                    return 'no';
...
//                },
            'menu':{
                'add':{
                    'label':'Add Page',
                    'fn':'M.ciniki_wng_main.site.save("M.ciniki_wng_main.edit.open(\'M.ciniki_wng_main.site.open();\',0,M.ciniki_wng_main.site.site_id);");',
                    },
                },
            },
        'footerpages':{'label':'Footer Menu', 'type':'simplegrid', 'num_cols':1, 'aside':'yes',
            'noData':'No footer menu',
            'visible':function() { 
                    if( M.ciniki_wng_main.site.view_aside == 'yes'
                        && M.ciniki_wng_main.site.sections._tabs.selected == 'footer' 
                        ) { 
                        return 'yes';
                    }
                return 'no';
...
//                },
        ...
        'orphanpages':{'label':'Other Pages', 'type':'simplegrid', 'num_cols':1, 'aside':'yes',
            'noData':'No Other Pages',
            'visible':function() { 
                    if( M.ciniki_wng_main.site.view_aside == 'yes'
                        && M.ciniki_wng_main.site.sections._tabs.selected == 'other' 
                        ) { 
                        return 'yes';
                    }
                    return 'no';
...
//                'theme':{'label':'Theme', 'visible':'yes', 'fn':'M.ciniki_wng_main.site.save("M.ciniki_wng_main.site.openSettings(\'theme\');");'},
                ...
                'cssoverrides':{'label':'Custom CSS', 'visible':'yes', 
                    'visible':function() { return M.modFlagSet('ciniki.wng', 0x1000); },
                    'fn':'M.ciniki_wng_main.site.save("M.ciniki_wng_main.site.openSettings(\'cssoverrides\');");',
                    },
                },
            },
        ...
        // Page sections
        //
        'pagedetails':{'label':'Page Details', 'type':'simplegrid', 'num_cols':2, 
            'active':function() { return (M.ciniki_wng_main.site.view == 'page' ? 'yes' : 'no'); },
            'cellClasses':['label', ''],
            'menu':{
                'edit':{
                    'label':'Edit', 
                    'fn':'M.ciniki_wng_main.edit.open(\'M.ciniki_wng_main.site.open();\',M.ciniki_wng_main.site.page_id,M.ciniki_wng_main.site.site_id);',
                    },
                'qrcode':{
                    'label':'Download QR Code', 
                    'fn':'M.ciniki_wng_main.qrcode.open(\'M.ciniki_wng_main.site.open();\',M.ciniki_wng_main.site.data.page.page_url,M.ciniki_wng_main.site.data.page.title);',
                    },
                'duplicate':{
                    'label':'Duplicate Page', 
                    'fn':'M.ciniki_wng_main.site.pageDuplicate();',
                    },
                },
            },
//            'fields':{
//                'title':{'label':'Menu Title', 'required':'yes', 'type':'text', 'editable':'no'},
...
//            'visible':function() { return (M.ciniki_wng_main.site.view == 'page' &&? 'yes' : 'hidden'); },
            'menu':{
                'add':{
                    'label':'Add Content',
                    'fn':'M.ciniki_wng_main.site.save("M.ciniki_wng_main.section.open(\'M.ciniki_wng_main.site.open();\',0,M.ciniki_wng_main.site.page_id,M.ciniki_wng_main.site.site_id);");',
                    },
                },
//            'addTxt':'Add Content',
...
//                    },
                ...
                'stripe-version':{'label':'Checkout Type', 'type':'select',
                    'visible':function() { M.modFlagSet('ciniki.sapos', 0x800000); },
                    'options':{
                        'default':'Original Stripe Popup',
                        'elements':'Stripe Checkout 2024',
                        },
                    },
                'stripe-whsec':{'label':'Stripe Webhook Signing Secret', 'type':'text',
                    'visible':function() { M.modFlagSet('ciniki.sapos', 0x800000); },
                    },
            }},
        'cartmessages':{'label':'Cart Messages', 'data':'settings',
            ...
            'fields':{
                ...
                'cart-etransfer-submitted-emails':{'label':'e-transfer Notifications', 'type':'text',
                    'visible':function() { return M.modFlagSet('ciniki.sapos', 0x40000000); },
                    },
                'cart-cheque-submitted-message':{'label':'Cheque Submitted', 'type':'textarea',
                    'visible':function() { return M.modFlagSet('ciniki.sapos', 0x8000); },
                    },
                'cart-cheque-submitted-emails':{'label':'Cheque Notifications', 'type':'text',
                    'visible':function() { return M.modFlagSet('ciniki.sapos', 0x8000); },
                    },
        ...
        'buttons':{'label':'',
            ...
            'buttons':{
                'save':{'label':'Save', 
                    'visible':function() { return M.ciniki_wng_main.site.view == 'page' || M.ciniki_wng_main.site.view == 'cssoverrides' ? 'no' : 'yes'; },
                    'fn':'M.ciniki_wng_main.site.save();',
                    },
                'savecss':{'label':'Save', 
                    'visible':function() { return M.ciniki_wng_main.site.view == 'cssoverrides' ? 'yes' : 'no'; },
...
/*        if( confirm("Are you sure you want to remove this image?") ) {
    ...
    this.site.rowClass = function(s, i, d) {
        if( (s == 'headerpages' || s == 'footerpages' || s == 'orphanpages') && this.page_id == d.id ) {
            return 'highlight' + (d.depth != null ? ' indent-' + d.depth : '');
        }
        if( (s == 'headerpages' || s == 'footerpages' || s == 'orphanpages') && d.depth != null ) {
...
/*        } */
    ...
    this.site.pageDuplicate = function() {
        M.api.getJSONCb('ciniki.wng.pageCopy', {'tnid':M.curTenantID, 'site_id':this.site_id, 'page_id':this.page_id}, function(rsp) {
                if( rsp.stat != 'ok' ) {
                    M.api.err(rsp);
                    return false;
                }
    ...
    this.edit.page_id = 0;
    this.edit.sections = {
        'parent':{'label':'Parent Page', 'fields':{
        ...
        'details':{'label':'', 'fields':{
            ...
            'ptype':{'label':'Format', 'type':'toggle', 'default':'10',
                'onchange':'M.ciniki_wng_main.edit.updateForm',
                'toggles':{
                    '10':'Sectioned',
                    '40':'Redirect',
...
//        'pageredirect':{'label':'Redirect', 
//            'active':function() { return M.ciniki_wng_main.edit.data.ptype == '40' ? 'yes' : 'no'; },
//            'visible':'hidden',
//            'fields':{
//                'redirect_url':{'label':'URL', 'type':'text'},
//                }},
...
/*    this.edit.switchType = function(e,s,f) {
        var e = this.formValue('ptype');
        if( ptype == '40' ) {
            this.sections.pageredirect.visible = 'yes';
        } else {
            this.sections.pageredirect.visible = 'hidden';
        }
        this.showHideSection('pageredirect');
//        this.save("M.ciniki_wng_main.edit.open(null," + this.page_id + "," + this.site_id + ");");
    } */
    this.edit.updateForm = function(s, i) {
        ...
        this.showHideFormField('details', 'redirect_url');
    }
...
/*                p.sections.parent.fields.parent_id.options = [];
                for(var i in M.ciniki_wng_main.site.data.pagelist) {
                    ...
                    p.sections.parent.fields.parent_id.options.push({
                        'id':M.ciniki_wng_main.site.data.pagelist[i].id,
...
//                && this.sections._settings.fields[i].url != ''
    ...
    //
    // The panel to edit a section repeat
    //
    ...
    this.sectionrepeat.open = function(cb,i,sid) {
        ...
        for(var i in this.sections.fields.fields) {
            if( this.sections.fields.fields[i].type != null 
                ...
                && this.sections.fields.fields[i].type == 'file_id'
                ) {
                this.sections.fields.fields[i].addDropFile = new Function('iid', 
                    'M.ciniki_wng_main.sectionrepeat.setFieldValue(\'' + i + '\',iid); '
                    + 'return true;');
                this.sections.fields.fields[i].deleteFile = new Function('iid', 
                    'M.ciniki_wng_main.sectionrepeat.setFieldValue(\'' + i + '\',0); '
                    + 'return true;');
            }
            else if( this.sections.fields.fields[i].type != null 
...
//        var c = new FormData;
        for(var i in this.sections.fields.fields) {
/*            if( this.sections.fields.fields[i].type == 'file' ) {
                var file = document.getElementById(this.panelUID + '_' + i);
                if( file != null && file.files != null && file.files[0] != null ) {
                    c.append(i + '-' + this.repeatnum, file.files[0]);
                } else {
                    var file = document.getElementById(this.panelUID + '_' + i + '_filename');
                    if( file != null && file.value == '' ) {
                        c.append(i + '-' + this.repeatnum, '');
                    }
                }
            }
            else { */
