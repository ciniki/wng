...
// <rsp stat='ok' />
//
function ciniki_wng_checkAccess(&$ciniki, $tnid, $method) {
    //
    ...
    $rc = ciniki_tenants_checkModuleAccess($ciniki, $tnid, 'ciniki', 'wng');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    $modules = $rc['modules'];
    ...
    if( !isset($rc['ruleset']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.wng.1', 'msg'=>'No permissions granted'));
    }
    ...
    if( in_array($method, array(
        'ciniki.wng.siteAdd',
        'ciniki.wng.siteDelete',
        'ciniki.wng.siteGet',
        'ciniki.wng.siteHistory',
        'ciniki.wng.siteList',
    ...
    $strsql = "SELECT tnid, user_id "
        ...
        . "AND (permission_group = 'owners' "
            . "OR (permission_group = 'employees' AND modperms like '%\"ciniki.wng\"%') "
            . "OR permission_group = 'resellers') "
        . "";
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbHashQuery');
    $rc = ciniki_core_dbHashQuery($ciniki, $strsql, 'ciniki.tenants', 'user');
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.wng.2', 'msg'=>'Access denied.'));
    }
    //
    ...
    // By default fail
    //
    return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.wng.3', 'msg'=>'Access denied'));
}
?>
