...
// -------
//
function ciniki_wng_page503Generate($ciniki, $tnid, $request, $errors) {
    ...
    $content .= "<h1 class='entry-title'>Maintenance</h1>";
    if( $errors != null && isset($errors['err']['msg']) ) {
        ...
        $content .= "<p>I'm sorry, but we are currently performing maintenance.</p>";
    }
    $content .= "</div>";
    $content .= "</div>";
    $content .= "</div>";
